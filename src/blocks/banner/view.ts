/**
 * Banner front-end view script: lazy-load background images.
 *
 * A banner whose background image opts into lazy loading renders with
...
/**
 * Wire up lazy loading for all lazy banners on the page.
 */
function init(): void {
