/**
 * Heading front-end view script: lazy-load background images.
 *
 * Headings whose background image opts into lazy loading render with
...
/**
 * Wire up lazy loading for all lazy headings on the page.
 */
function init(): void {
