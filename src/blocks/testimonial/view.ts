/**
 * Testimonial front-end view script: lazy-load background images.
 *
 * A card whose background image opts into lazy loading renders with
...
/**
 * Wire up lazy loading for all lazy testimonial cards on the page.
 */
function init(): void {
