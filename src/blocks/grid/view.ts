/**
 * Grid front-end view script: lazy-load background images.
 *
 * A grid whose background image opts into lazy loading renders with
...
/**
 * Wire up lazy loading for all lazy grids on the page.
 */
function init(): void {
